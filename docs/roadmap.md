...
### 5.1 Интеграция с OpenRouter API

- [X] Создать модуль для работы с OpenRouter API (openrouter_service.py)
- [X] Реализовать функцию транскрипции аудио в текст через OpenAI Whisper API
- [X] Реализовать функцию парсинга текста транзакции через DeepSeek v3.1:free
...
- [X] Отправить текст на парсинг в DeepSeek LLM
...
- [X] Добавить fallback на случай недоступности OpenRouter API
